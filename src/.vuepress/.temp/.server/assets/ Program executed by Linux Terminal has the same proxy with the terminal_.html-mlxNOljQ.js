...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/ Program executed by Linux Terminal has the same proxy with the terminal_.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _Program_executed_by_Linux_Terminal_has_the_same_proxy_with_the_terminal__html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", " Program executed by Linux Terminal has the same proxy with the terminal_.html.vue"]]);
export {
  _Program_executed_by_Linux_Terminal_has_the_same_proxy_with_the_terminal__html as default
};
