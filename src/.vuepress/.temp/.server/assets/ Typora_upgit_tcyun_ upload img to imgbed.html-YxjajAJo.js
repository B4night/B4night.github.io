...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/ Typora_upgit_tcyun_ upload img to imgbed.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _Typora_upgit_tcyun__upload_img_to_imgbed_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", " Typora_upgit_tcyun_ upload img to imgbed.html.vue"]]);
export {
  _Typora_upgit_tcyun__upload_img_to_imgbed_html as default
};
