...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/ Fedora set display scale 150%(gnome).html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _Fedora_set_display_scale_150__gnome__html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", " Fedora set display scale 150%(gnome).html.vue"]]);
export {
  _Fedora_set_display_scale_150__gnome__html as default
};
