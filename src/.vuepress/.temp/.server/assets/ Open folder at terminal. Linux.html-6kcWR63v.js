...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/ Open folder at terminal. Linux.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _Open_folder_at_terminal__Linux_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", " Open folder at terminal. Linux.html.vue"]]);
export {
  _Open_folder_at_terminal__Linux_html as default
};
