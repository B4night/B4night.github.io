import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as i,b as s,d as e}from"./app-YaDZZJVQ.js";const a={},o=s("h1",{id:"useful-script-sharing-easy-git-push",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#useful-script-sharing-easy-git-push"},[s("span",null,"Useful script sharing: easy git push")])],-1),c=s("p",null,[e("When dealing with github repositories, it’s often the case that we should use "),s("code",null,'git add .; git commit -s -m ""; git push'),e(" to push our changes.")],-1),r=s("p",null,"So that I am gonna share a simple shell script that could do some simple git operations.",-1),h=s("pre",null,[s("code",null,`acp() {
    if [ ! $# -eq 1 ]; then
